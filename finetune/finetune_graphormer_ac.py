...
def finetune(cfg, benchmark, device):
    ...
    #set up model
    # --------
    config_file = '/share/project/tanghan/sharefs-hantang/tanghan/Chemical_Reaction_Pretraining/test/assets/graphormer.yaml'
...
@hydra.main(version_base=None, config_path="/share/project/tanghan/sharefs-hantang/tanghan/Chemical_Reaction_Pretraining/conf", config_name="finetune")
def main(cfg):
